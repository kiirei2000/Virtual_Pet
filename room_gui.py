...
class RoomGUI:
    def __init__(self, root: tk.Tk):
        ...
        self.animations = {
            ...
            "laydown":   load_gif(ASSETS / "laydown.gif", CAT_SCALE),
            ...
            "excited":   load_gif(ASSETS / "excited.gif", CAT_SCALE),
            "surprised": load_gif(ASSETS / "surprised.gif", CAT_SCALE),
        }
        self.toy_anims = {
            "ball":  load_gif(ASSETS / "BlueBall.gif", CAT_SCALE),
            "mouse": load_gif(ASSETS / "mouse.gif"),
        }
        ...
        if is_hungry:
            ...
            if self.state == "idle" and now >= self._next_wander:
                ...
                if random.random() < 0.3:
                    emotion = random.choice(["excited", "surprised"])
                    self._set_state(emotion)
    ...
    def _on_click(self, event):
        ...
        if clicked_tag == "bowl_food":
        ...
        elif clicked_tag == "bed" and not is_hungry:
            self.actions.sleep()
            ...
            self.canvas.coords(self.cat_id, self.BATH_X, self.BATH_Y)
            self.busy_until = now + 5
